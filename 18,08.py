...
class InputTableApp(QWidget):
    ...
    def initUI(self):
        ...
        # Allow the table to expand both vertically and horizontally
        self.table.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)

        # Set all column widths to be equal and stretching
        ...
        min_width = max(220 * self.cols, 1300)  # Ensure it's at least 1300 wide
